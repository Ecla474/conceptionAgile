...
public class PlayerFactory implements PlayerInterface{
    ...
    @Override
    public Player creerPlayer(GraphicsContext gc, Player.typeJoueur couleurJoueur, int xInit, int yInit, Player.orientation position, Player.strategie strat, int width , double v){
